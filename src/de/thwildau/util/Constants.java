...
public class Constants {
	...
	public static final String ERROR_ARG_SYNTAX = "Wrong argument syntax! Correct syntax: -arg [option]";
	public static final String ERROR_ARG_OPTION = "Wrong option given for argument";
	public static final String ERROR_ARG_UNKNOWN = "Unknown argument given";
