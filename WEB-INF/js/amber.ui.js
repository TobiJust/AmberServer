...
amber.ui.appendCars = function (data) {
    ...
    for (var l = 0; l < data.length; l++) {
        ...
        var element = '<li class="car"' + 'carname="' + car.vehicleName + '"' + 'carid="' + car.vehicleID + '">';
...
amber.ui.getRecordData = function () {
    // build an object for in-app data communication
    var recordData = {};
    recordData.carID = amber.cars.Current.id;
    recordData.userID = amber.userID;
    return recordData;
}
